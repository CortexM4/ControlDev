 ...
 *
 */
public class VideoStreamProcess implements Runnable, CaptureCallback{
	 ...
	 */
	public VideoStreamProcess(String dev, int width, int height, int port, int fps) throws V4L4JException, IOException {
